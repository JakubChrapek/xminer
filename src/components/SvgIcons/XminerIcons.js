...
const pathCircleVariants = {
  initial: {},
  animate: {
    y: [Math.ceil(Math.random(5) + 5), 0, -Math.floor(Math.random(70) + 15)],
    x: [Math.ceil(Math.random(30) - 15), 0, -Math.floor(Math.random(20) - 10)],
    opacity: [0, 1, 0],
    scale: [0.6, 1, 1.2, 0.9, 0.7],
    transition: {
...
export const HeroIcon = () => {
  const getRandomNumberBetween = (min, max) => {
    return Math.floor(Math.random() * Math.ceil(max)) + Math.ceil(min)
  }
  ...
  const calculateAnimationForCirclePath = (
    yStart,
    yFinish,
    xStart,
    xFinish,
    ...
    return {
      y: [
        getRandomNumberBetween(Math.abs(-yStart / 2), yFinish / 2),
        0,
        -getRandomNumberBetween(Math.abs(-yStart), yFinish),
      ],
      x: [
        getRandomNumberBetween(-xStart / 2, xFinish / 2),
        0,
        getRandomNumberBetween(-xStart, xFinish),
      ],
      opacity: [0, 0.6, 0.8, 1, 0],
      scale: [0.8, 0.84, 0.92, 1, 0.97],
      transition: {
        duration: getRandomNumberBetween(minDur, durationVar),
        delay: getRandomDelay(1.6),
        repeat: Infinity,
        ease: [0.4, 0.55, 0.68, 0.88],
      },
    }
  }
              ...
              <g id="whole-icon">
                ...
                >
                  <motion.path
                    ...
                    initial="initial"
                    animate={calculateAnimationForCirclePath(7, 49, 14, 22, 2)}
                    id="g3"
                  ...
                  <motion.path
                    variants={pathCircleVariants}
                    initial="initial"
                    animate={calculateAnimationForCirclePath(0, 50, 3, 1, 3)}
                    id="g6"
                  ...
                  <motion.path
                    variants={pathCircleVariants}
                    initial="initial"
                    animate={calculateAnimationForCirclePath(
                      10,
                      60,
                      20,
                      40,
                  ...
                  <motion.path
                    variants={pathCircleVariants}
                    initial="initial"
                    animate={calculateAnimationForCirclePath(0, 32, 5, 10, 3.4)}
                    id="g7"
                  ...
                  <motion.path
                    variants={pathCircleVariants}
                    initial="initial"
                    animate={calculateAnimationForCirclePath(10, 37, 10, 20, 3)}
                    id="g8"
                  ...
                  <motion.path
                    variants={pathCircleVariants}
                    initial="initial"
                    animate={calculateAnimationForCirclePath(15, 46, 6, 12, 4)}
                    id="g4"
                  ...
                  <motion.path
                    variants={pathCircleVariants}
                    initial="initial"
                    animate={calculateAnimationForCirclePath(14, 41, 12, 36, 4)}
                    id="g5"
                ...
                >
                  <motion.path
                    variants={pathCircleVariants}
                    initial="initial"
                    animate={calculateAnimationForCirclePath(3, 22, 9, 16, 2.4)}
                    id="l1"
                  ...
                  <motion.path
                    variants={pathCircleVariants}
                    initial="initial"
                    animate={calculateAnimationForCirclePath(7, 32, 5, 27, 2.8)}
                    id="l4"
                  ...
                  <g id="Group_2" opacity=".9">
                    <motion.path
                      ...
                      opacity=".9"
                    />
                    <motion.path id="l3" d="M234 119z" opacity=".9" />
                  </g>
                  <motion.path
                    id="l5"
