    ...
    <ActiveStepStyles>
      <StyledFlex direction="column">
        <AnimatePresence exitBeforeEnter>
          ...
          >
            Krok <motion.span>{activeStep + 1}</motion.span>/{steps.length}
          </Text>
          <Text
            margin="19px 0 0"
            fontSize="24px"
      ...
      <StyledFlex direction="column">
        ...
        <StyledFlex margin="54px 0 0" width="100%" justifyContent="flex-end">
          <AnimatePresence>
            {activeStep > 0 && (
              <Button
    ...
    <Container bg="var(--nav-dark-bluse)">
      <ConfiguratorWrapperStyles direction="column">
        ...
        >
          ...
          <Configurator vendors={[amdLogoImg, nvidiaLogoImg]} />
        </ConfiguratorFlexStyles>
